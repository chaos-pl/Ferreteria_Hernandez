            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="am" class="form-control @error('am') is-invalid @enderror"
                           value="{{ old('am',$persona->am) }}" maxlength="150">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="telefono" class="form-control @error('telefono') is-invalid @enderror"
                           value="{{ old('telefono',$persona->telefono) }}" maxlength="20">
                ...
                <div class="col-12">
                    ...
                    <select name="direcciones_id" class="form-select @error('direcciones_id') is-invalid @enderror">
                        ...
                        @foreach($direcciones as $d)
                            <option value="{{ $d->id }}"
                                {{ (int)old('direcciones_id',$persona->direcciones_id)===(int)$d->id?'selected':'' }}>
