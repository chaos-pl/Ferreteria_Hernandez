...
@section('dashboard-content')
    <div class="container py-4">
        <h3 class="mb-3">Nueva asignación producto–proveedor</h3>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="productos_id" class="form-select" required>
                        ...
                        @foreach($productos as $p)
                            <option value="{{ $p->id }}"
                                @selected(old('productos_id', $preProducto ?? '')==$p->id)>{{ $p->nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select name="proveedores_id" class="form-select" required>
                        ...
                        @foreach($proveedores as $v)
                            <option value="{{ $v->id }}"
                                @selected(old('proveedores_id', $preProveedor ?? '')==$v->id)>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="sku_proveedor" class="form-control"
                           value="{{ old('sku_proveedor') }}" maxlength="80">
